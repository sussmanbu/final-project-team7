...
The data we choose for our project is: Low- to Moderate-Income New York State Census Population Analysis Dataset. The data source is: [https://www.nyserda.ny.gov/lmi-tool](https://www.nyserda.ny.gov/lmi-tool)
