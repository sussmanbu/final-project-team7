...
As we used map visualiztion to show the county difference in a NY state map, we also brought in map data that is stored in our data-ignore data. Here is a code of how we import the data
